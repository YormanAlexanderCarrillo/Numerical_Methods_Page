...
const FormSecante = ({onResponse}) => {
    ...
    const sendMethod = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.1.49:5000/secante', parsedFormData)
            onResponse(response)
                            ...
                            <form action="/puntofijo" onSubmit={sendMethod}>
                                ...
                                <div className="mb-4 flex flex-col sm:flex-row">
                                    ...
                                    <div className='w-full'>
                                        <Input id="valueInitial" name='Xo' type="number" label="Xo" value={formData.Xo} onChange={handleChange} variant="bordered" isRequired />
                                    </div>
